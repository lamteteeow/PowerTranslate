# Local Installation Guide (PowerTranslate 1.1.2.0)
...
```powershell
Test-Path .\PowerTranslateExtension\AppPackages\PowerTranslateExtension_1.1.2.0_x64_Test\PowerTranslateExtension_1.1.2.0_x64.cer
Test-Path .\PowerTranslateExtension\AppPackages\PowerTranslateExtension_1.1.2.0_x64_Test\PowerTranslateExtension_1.1.2.0_x64.msix
```

## 2) Import signing certificate

```powershell
Import-Certificate -FilePath ".\PowerTranslateExtension\AppPackages\PowerTranslateExtension_1.1.2.0_x64_Test\PowerTranslateExtension_1.1.2.0_x64.cer" -CertStoreLocation "Cert:\CurrentUser\TrustedPeople"
```
...
```powershell
Add-AppxPackage -Path ".\PowerTranslateExtension\AppPackages\PowerTranslateExtension_1.1.2.0_x64_Test\PowerTranslateExtension_1.1.2.0_x64.msix" -ForceUpdateFromAnyVersion
```
