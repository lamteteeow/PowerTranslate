...
| Manifest version uses Store-safe revision `.0` | App package requirements / Store validation | PASS | `Version="1.1.2.0"` in `PowerTranslateExtension/Package.appxmanifest` |
...
| Store upload artifact generated successfully | Upload app packages guidance | PASS | `PowerTranslateExtension/AppPackages/PowerTranslateExtension_1.1.2.0_x64.msixupload` |
| GitHub release sideload artifacts use signed Release package | Release distribution validation | PASS | `PowerTranslateExtension_1.1.2.0_x64.msix` and `.cer` attached to `v1.1.2.0` |
...
- `PowerTranslateExtension/AppPackages/PowerTranslateExtension_1.1.2.0_x64.msixupload`

## GitHub Release Artifacts

For local sideload installation, the `v1.1.2.0` GitHub release includes:

- `PowerTranslateExtension_1.1.2.0_x64.msix`
- `PowerTranslateExtension_1.1.2.0_x64.cer`
